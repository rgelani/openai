...
<template>
    <Head :title="title" />
            ...
            <Chat>
                <template #aside>
                    <ul class="p-2">
                        <li v-if="chat" class="px-4 py-2 my-2 flex justify-between font-semibold text-green-400 bg-slate-900 hover:bg-slate-700 rounded-lg">
                        ...
                        <template v-for="message in messages" :key="message.id">
                            ...
                            <li 
                            :class="[(message && chat && message.id === chat.id) ?
                                'bg-slate-700' :
                                'bg-slate-900',
                                'px-4 py-2 my-2 flex justify-between font-semibold text-slate-400 bg-slate-900 hover:bg-slate-700 rounded-lg'
                            ]"
                            >
